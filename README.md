...
- `prestataires.html` : version de présentation destinée aux prestataires et partenaires (mêmes sections que l'invitation, sans formulaire d'inscription, sans espace staff et sans lien WhatsApp ; aucune donnée collectée). Servie à `/prestataires.html`, non indexée (`noindex`).
